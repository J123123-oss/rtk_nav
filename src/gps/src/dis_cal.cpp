...
public:
    DistanceCalculator()
    {
        ...
        geographic_msgs::msg::GeoPoint point1, point2;
        ...
        RCLCPP_INFO(rclcpp::get_logger("Gps"), "UTM Distance: %.2f meters", utm_dist);
        RCLCPP_INFO(rclcpp::get_logger("Gps"), "Haversine Distance: %.2f meters", haversine_dist);
    }
    
    double calculateUTMDistance(const geographic_msgs::msg::GeoPoint& p1, 
                              const geographic_msgs::msg::GeoPoint& p2)
    {
        ...
        {
            RCLCPP_WARN(rclcpp::get_logger("Gps"), "Points are in different UTM zones!");
        }
    ...
    double calculateHaversineDistance(const geographic_msgs::msg::GeoPoint& p1,
                                    const geographic_msgs::msg::GeoPoint& p2)
    {
...
int main(int argc, char** argv)
{
    ...
    auto node = rclcpp::Node::make_shared("distance_calculator");
