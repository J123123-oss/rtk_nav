...
def main():
    ...
    param = {
        'corner1': (
            get_ros_param('~corner1/lon', 120.06910407),
            get_ros_param('~corner1/lat', 30.32000295)
        ),
        'corner2': (
            get_ros_param('~corner2/lon', 120.06706355),
            get_ros_param('~corner2/lat', 30.32097315)
        ),
        'interval': get_ros_param('~interval', 4),
        'edge_distance_lon': get_ros_param('~edge_distance_lon', 10),
        'edge_distance_lat': get_ros_param('~edge_distance_lat', 10)
    }
